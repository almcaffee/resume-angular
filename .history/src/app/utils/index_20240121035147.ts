...
/**
 * Creates a toast message based to the error response from the api
 * TODO: Ensure api is returning consistently formatted errors
 * @param err HttpErrorResponse
 * @returns A toast message to send to the message service
 */
