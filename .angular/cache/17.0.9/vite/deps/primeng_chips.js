import {
  NG_VALUE_ACCESSOR,
  NgModel
} from "./chunk-J5CQX67C.js";
import {
  TimesCircleIcon
} from "./chunk-JEDTU54L.js";
import {
  TimesIcon
} from "./chunk-WVY2THSC.js";
import "./chunk-54XJLZHM.js";
import {
  PrimeTemplate,
  SharedModule,
  UniqueComponentId
} from "./chunk-RCP32DAF.js";
import {
  CommonModule,
  DOCUMENT,
  NgClass,
...
function Chips_li_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵattribute("id", ctx_r1.id + "_chips_item_" + i_r5)("ariaLabel", item_r4)("aria-selected", true)("aria-setsize", ctx_r1.value.length)("aria-pointset", i_r5 + 1)("data-p-focused", ctx_r1.focusedIndex === i_r5)("data-pc-section", "token");
    ɵɵadvance(2);
